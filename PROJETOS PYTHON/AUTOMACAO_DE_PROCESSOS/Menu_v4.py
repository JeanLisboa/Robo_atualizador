...
puxar a variável mês dentro da função gera lista pedidos sem agenda
...
class Feedback(object):
    ...
    def executar(self):
        ...
        if processo == '1':
            ...
            Feedback.navegador(self)
            Feedback.Intranet.acessa_tela_atualizar_expedicao(self=Feedback.Intranet)

        if processo == '2':
            # self.combobox.state(['!disabled'])

            Feedback.navegador(self)
            Feedback.Intranet.atualiza_agenda(self=Feedback.Intranet)
            # navegador.close()
        ...
        if processo == '3':
            # self.combobox.state(['disabled'])
            Feedback.navegador(self)
            Feedback.Intranet.acessa_tela_atualizar_entrega(self=Feedback.Intranet)
            # navegador.close()
    ...
    def fechar(self):
        ...
        # Feedback.Intranet.navegador.close()
    ...
    def tsi(self):
        ...
        data = date.today()
        Feedback.Intranet.navegador.get('https://tsicliint.intecomlogistica.com.br/#/')

        print("Logging")
        Feedback.Intranet.navegador.find_element('xpath', '//*[@id="q-app"]/div/div/main/div/div[3]/label[1]'). \
            send_keys('jean.lino@baruel.com.br')
        Feedback.Intranet.navegador.find_element('xpath', '//*[@id="q-app"]/div/div/main/div/div[3]/label[2]'). \
            send_keys('151082')
        Feedback.Intranet.navegador.find_element('xpath', '//*[@id="q-app"]/div/div/main/div/div[4]/button[2]'). \
            send_keys(Keys.ENTER)
        sleep(2.0)
        print('Opções de Download')

        Feedback.Intranet.navegador.find_element('xpath', '//*[@id="q-app"]/div/header/div/button').click()
        # sleep(2.0)
        Feedback.Intranet.navegador.find_element('xpath', '/html/body/div[3]/div/a[5]/div[2]/div').click()
        sleep(2.0)

        Feedback.Intranet.navegador.find_element('xpath', '//*[@id="tabelaFornecedores"]/div[1]/div[3]/div/button').send_keys(Keys.ENTER)
        #    sleep(2.0)
        ...
        sleep(15.0)
        Feedback.Intranet.navegador.find_element('xpath',
                               '/html/body/div[3]/div[2]/div/div[2]/div[2]/div[2]/label/div/div/div[1]/input').send_keys(
            dta_inicial_formatada)

        sleep(3.0)
        Feedback.Intranet.navegador.find_element('xpath', '/html/body/div[3]/div[2]/div/div[2]/div[2]/div[3]/label').send_keys(
            dta_final_formatada)
        sleep(3.0)
        print('Seleciona filial')
        #
        Feedback.Intranet.navegador.find_element('xpath', '/html/body/div[3]/div[2]/div/div[2]/div[3]/div[2]/label').click()
        sleep(2.0)

        print(" Seleciona 'João Pessoa'")
        Feedback.Intranet.navegador.find_element('xpath', '//*[@id="qvs_5"]/div[4]').send_keys(Keys.ENTER)
        sleep(3.0)

        print('Clica em filtrar')
        Feedback.Intranet.navegador.find_element('xpath', '/html/body/div[3]/div[2]/div/div[3]/button[2]').send_keys(Keys.ENTER)
        sleep(30.0)

        print('Baixar planilha')
        Feedback.Intranet.navegador.find_element('xpath', '/html/body/div[1]/div/div/main/div[2]/div[1]/div[3]/div/div/button').send_keys(
            Keys.ENTER)
        sleep(10.0)
    ...
    class Tracking:
        ...
        def importa_data_expedicao(self):
            ...
            Feedback.Intranet.acessa_tela_tracking(self=Feedback.Intranet)  # importa a lista de nfs nao entregues
            a = Feedback.Intranet.gera_lista_nfs_nao_expedidas(self=Feedback.Intranet)
        ...
        def importa_data_agenda(self):
            ...
            a = Feedback.Intranet.gera_lista_ped_sem_agenda(self=Feedback.Intranet)
            df = pd.read_excel('G:\Drives compartilhados\CUSTOMER SERVICE\AREA 02 NE\Tracking BNE - 2023.xlsx',
                               sheet_name='BASE TRACKING 2023')
        ...
        def importa_data_entrega(self):
            ...
            a = Feedback.Intranet.gera_lista_nfs_nao_entregues(self=Feedback.Intranet)  # trf a lst em var
            df = pd.read_excel('G:\Drives compartilhados\CUSTOMER SERVICE\AREA 02 NE\TRACKING NE-BS-2023.xlsx',
                               sheet_name='BASE TRACKING 2023')
    ...
    class Intranet:
        ...
        def acessa_intranet(self):
            ...
            Feedback.Intranet.navegador.get('http://45.236.77.106:51236/intranet/login.php')

            # fazer  login
            Feedback.Intranet.navegador.find_element('xpath','/html/body/form/table/tbody/tr[2]/td/table/tbody/tr[2]/td[2]/input').clear()

            Feedback.Intranet.navegador.find_element('xpath','/html/body/form/table/tbody/tr[2]/td/table/tbody/tr[2]/td[2]/input').send_keys(
                'jean.lino')
            Feedback.Intranet.navegador.find_element('xpath','/html/body/form/table/tbody/tr[2]/td/table/tbody/tr[3]/td[2]/input').send_keys(
                'Ma250509')
            Feedback.Intranet.navegador.find_element('xpath','/html/body/form/table/tbody/tr[2]/td/table/tbody/tr[3]/td[2]/input').send_keys(
                Keys.ENTER)

        def acessa_tela_pedidos_otc(self):
            Feedback.Intranet.navegador.find_element('xpath','/html/body/form/table/tbody/tr[2]/td[2]/select').send_keys('L')
            Feedback.Intranet.navegador.find_element('xpath','/html/body/form/table/tbody/tr[2]/td[2]/select').send_keys(Keys.ENTER)
            print('acessa logística')
            # acessar 'Logística'
            Feedback.Intranet.navegador.find_element('xpath', '//*[@id="navigation"]/ul/li[2]/a').click()
            print('acessa pedidos otc')
            # acessar pedidos otc
            Feedback.Intranet.navegador.find_element('xpath', '//*[@id="navigation"]/ul/li[2]/ul/a[2]').click()

            if Feedback.dist == 2:  # extrema
                Feedback.Intranet.navegador.find_element('xpath','/html/body/form[2]/table[1]/tbody/tr[2]/td[1]/select').send_keys(Keys.ARROW_DOWN)
                Feedback.Intranet.navegador.find_element('xpath','/html/body/form[2]/table[1]/tbody/tr[2]/td[1]/select').send_keys(Keys.ARROW_DOWN)

            if Feedback.dist == 1:  # Alhandra
                Feedback.Intranet.navegador.find_element('xpath','/html/body/form[2]/table[1]/tbody/tr[2]/td[1]/select').send_keys(Keys.ARROW_UP)
                Feedback.Intranet.navegador.find_element('xpath','/html/body/form[2]/table[1]/tbody/tr[2]/td[1]/select').send_keys(Keys.ARROW_UP)
                Feedback.Intranet.navegador.find_element('xpath','/html/body/form[2]/table[1]/tbody/tr[2]/td[1]/select').send_keys(Keys.ARROW_DOWN)

        def acessa_tela_tracking(self):
            print('Classe: Intranet, Método: acessa_tela_tracking')
            Feedback.Intranet.acessa_intranet(self)

            # acessar 'Customer Services'
            print('Acessa Customer Services')
            Feedback.Intranet.navegador.find_element('xpath', '//*[@id="navigation"]/ul/li[4]/a').click()
            # acessar Tracking
            print('Acessa Distribuidor')
            Feedback.Intranet.navegador.find_element('xpath', '//*[@id="navigation"]/ul/li[4]/ul/a[1]').click()
        ...
        def gera_lista_nfs_nao_expedidas(self):
            ...
            Feedback.Intranet.navegador.find_element('xpath', '//*[@id="calendario2"]').send_keys(Keys.CLEAR)
            Feedback.Intranet.navegador.find_element('xpath', '//*[@id="calendario2"]').send_keys(dia_ini_formatado)
            Feedback.Intranet.navegador.find_element('xpath', '//*[@id="calendario2"]').send_keys(mes_ini_formatado)
            Feedback.Intranet.navegador.find_element('xpath', '//*[@id="calendario2"]').send_keys(dta_inicial.year)
            Feedback.Intranet.navegador.find_element('xpath',
            ...
            Feedback.Intranet.navegador.find_element('xpath', '/html/body/form[2]/table[5]/tbody/tr[2]/td[8]')
            nfs_nao_expedidas = []
            tr = 2
            try:
                while True:
                    # campo NF da linha   >>> td[8]
                    linha = Feedback.Intranet.navegador.find_element('xpath',
        ...
        def acessa_tela_atualizar_expedicao(self):
            ...
            tracking = Feedback.Tracking.importa_data_expedicao(self=Feedback.Tracking)
            # # acessar 'Customer Services'
            Feedback.Intranet.navegador.find_element('xpath',
            ...
            for nf, data in tracking.items():
                ...
                # data de expedicao
                Feedback.Intranet.navegador.find_element('xpath', '//*[@id="calendario1"]').send_keys(data)
        ...
        def gera_lista_ped_sem_agenda(self):
            ...
            #opcao_mes
            # mes = Feedback.selec_mes
            mes = Feedback.mes

            print(f'Mês selecionado: {mes}')
            # mes = str(input("Mês (mmm): "))
            print('Feedback.Intranet.acessa_intranet')
            Feedback.Intranet.acessa_intranet(self)
            print('Feedback.Intranet.acessa_tela_pedidos_otc')
            Feedback.Intranet.acessa_tela_pedidos_otc(self)
            print('seleciona mês')
            # seleciona mês
            Feedback.Intranet.navegador.find_element('xpath','/html/body/form[2]/table[1]/tbody/tr[2]/td[3]/select').send_keys(f'{mes}')
            print(f'Mês de pesquisa: {mes}')

            # seleciona a tela de agendamento
            Feedback.Intranet.navegador.find_element('xpath','/html/body/form[2]/table[1]/tbody/tr[2]/td[2]/select').send_keys('agendamento')
            # SELECIONA REGIONAL

            if Feedback.dist == 1 and area in lst_area:
                Feedback.Intranet.navegador.find_element('xpath','/html/body/form[2]/table[1]/tbody/tr[2]/td[8]/select').send_keys(f'{area}')
            # processa
            Feedback.Intranet.navegador.find_element('xpath', '/html/body/form[2]/table[2]/tbody/tr/td/input').click()
            tr = 1
            pedidos_sem_agenda = []
        ...
        def atualiza_agenda(self):
            ...
            tracking = Feedback.Tracking.importa_data_agenda(self=Feedback.Tracking)
            print(tracking)
            print('----------------------------------')
            ano = 2023
            cont_tr = 1
            ...
            try:
                while True:
                    for i in tracking:
                        ...
                        nome = Feedback.Intranet.navegador.find_element('xpath',
                ...
                Feedback.Intranet.navegador.find_element('xpath', '/html/body/form[2]/div[2]/input').click()

        def acessa_tela_atualizar_entrega(self):
            print('Classe: Intranet, Método: acessa_tela_atualizar_entrega')
            tracking = Feedback.Tracking.importa_data_entrega(self=Feedback.Tracking)

            # # acessar 'Customer Services'

            Feedback.Intranet.navegador.find_element('xpath', '//*[@id="navigation"]/ul/li[4]/a').click()
            Feedback.Intranet.navegador.find_element('xpath', '//*[@id="navigation"]/ul/li[4]/ul/a[5]').click()
            ...
            if Feedback.dist == 2:  # bs-extrema
                ...
                Feedback.Intranet.navegador.find_element('xpath',
                    ...
                    Keys.ARROW_DOWN)
                Feedback.Intranet.navegador.find_element('xpath',
                                                         '/html/body/form[2]/table[2]/tbody/tr/td/input').click()
            # ACESSA A TELA 'ENTREGA'
            Feedback.Intranet.navegador.find_element('xpath',
                                                     '/html/body/form[2]/table[1]/tbody/tr[2]/td[10]/a').click()
            ...
            for nf, data in tracking.items():
                ...
                Feedback.Intranet.navegador.find_element('xpath','/html/body/form[2]/table[1]/tbody/tr[2]/td[2]/input').send_keys(nf)
                # data de entrega
                Feedback.Intranet.navegador.find_element('xpath', '//*[@id="calendario1"]').send_keys(data)

                #  grava
                Feedback.Intranet.navegador.find_element('xpath','/html/body/form[2]/table[1]/tbody/tr[2]/td[4]/input').send_keys(Keys.ENTER)
        ...
        def gera_lista_nfs_nao_entregues(self):
            ...
            Feedback.Intranet.navegador.find_element('xpath','/html/body/form[2]/table[1]/tbody/tr[2]/td[2]/select').click()
            Feedback.Intranet.navegador.find_element('xpath','/html/body/form[2]/table[1]/tbody/tr[2]/td[2]/select/option[3]').click()
        ...
        def atualiza_entrega(self):
            ...
            Feedback.Intranet.gera_lista_nfs_nao_entregues(self)  # FUNCIONANDO

            # buscar datas de entrega na planilha
            # retornar dicionario
            print('Tracking.importa_data_entrega(self)')
            Feedback.Tracking.importa_data_entrega(self)  # funcionando
