...
class Feedback:
    ...
    def executar(self):
        ...
        if processo == '2':
            try:
                ...
                print('Erro: janela Fechada...')
                print('... abrindo novo navegador...')
    ...
    def tsi(self):
        ...
        print("Logging")
        Intranet.navegador.find_element('xpath', '//*[@id="q-app"]/div/div/main/div/div[3]/label[1]').send_keys('jean.lino@baruel.com.br')
        Intranet.navegador.find_element('xpath', '//*[@id="q-app"]/div/div/main/div/div[3]/label[2]').send_keys('151082')
        Intranet.navegador.find_element('xpath', '//*[@id="q-app"]/div/div/main/div/div[4]/button[2]').send_keys(Keys.ENTER)
        sleep(2.0)
